...
- (UICollectionViewLayoutAttributes *)attributes:(UICollectionViewLayoutAttributes *)attributes atIndexPath:(NSIndexPath *)indexPath
{
    ...
    while(index++ < totalInSection - 1) {
        ...
        UICollectionViewLayoutAttributes *next = [super layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:index inSection:indexPath.section]].copy;
    ...
    while (index-- > 0) {
        ...
        UICollectionViewLayoutAttributes *prev = [super layoutAttributesForItemAtIndexPath:[NSIndexPath indexPathForItem:index inSection:indexPath.section]].copy;
